...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 100, 371, 16))
        ...
        self.label_32.setGeometry(QtCore.QRect(10, 249, 451, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Conversion Simple à partir d\'un fichier :"))
        self.pushButton_4.setText(_translate("MainWindow", "Conversion 14 param à partir d\'un fichier :"))
        self.pushButton_5.setText(_translate("MainWindow", "Conversion ECEF LLA à partir d\'un fichier :"))
    ...
    def c_quato_file(self):
        ...
        fichier = self.plainTextEdit.toPlainText()
        sep_valeurs = self.plainTextEdit_21.toPlainText()
        inProj = int(self.plainTextEdit_29.toPlainText())
        outProj = int(self.plainTextEdit_30.toPlainText())
        time_acquisition = self.plainTextEdit_31.toPlainText()
        direction_pos = self.plainTextEdit_32.toPlainText()
    ...
    def c_GEOcrs_file(self):
        ...
        fichier = self.plainTextEdit.toPlainText()
        sep_valeurs = self.plainTextEdit_21.toPlainText()
        proj_ecef = self.plainTextEdit_33.toPlainText()
        ellps_ecef = self.plainTextEdit_34.toPlainText()
        datum_ecef = self.plainTextEdit_35.toPlainText()
        proj_lla = self.plainTextEdit_36.toPlainText()
        ellps_lla = self.plainTextEdit_38.toPlainText()
        datum_lla = self.plainTextEdit_37.toPlainText()
    ...
    def c_quato_unique(self):
        inProj = int(self.plainTextEdit_6.toPlainText())
        outProj = int(self.plainTextEdit_9.toPlainText())
